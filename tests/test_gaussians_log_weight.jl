using Test
using LatticeDecoder: gaussian_log_weight, MIN_VAR
...
function test_gaussian_assignment()
    @testset begin
        ...
        @test g1.mean == 0.5 && g1.var == 0.5 && g1.log_weight == 0.0 && g1.period == 0.0
        @test g2.mean == 0.5 && g2.var == MIN_VAR && g2.log_weight == 0.0 && g2.period == 0.0
        @test g3.mean == -0.5 && g3.var == 0.1 && g3.log_weight == 0.5 && g3.period == 0.0
...
function test_gaussian_divide()
    ...
    g1 = gaussian_log_weight(0.1, 0.1, -10)
    g2 = gaussian_log_weight(-0.2, 0.2, -20)
    g3 = gaussian_log_weight(-0.3, 0.3, -30)
