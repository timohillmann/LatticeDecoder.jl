...
const VarNodeAlloc = FourGaussianLogAlloc(gaussian_log_weight(0.0, LatticeDecoder.BP_DEFAULT_ALLOC_VARIANCE))

const MotherNodeAlloc = SixGaussianLogAlloc(gaussian_log_weight(0.0, LatticeDecoder.BP_DEFAULT_ALLOC_VARIANCE))
...
function run_belief_propagation!(tg::TannerGraph, message::Vector{Float64}, σ::Float64, max_iter::Int64, decoder::Union{String, Int64}="lsd"; search_interval::Float64=1.5, lsd_beta::Float64=LatticeDecoder.LSD_DEFAULT_BETA, lsd_w_min::Float64=LatticeDecoder.LSD_W_MIN)
    ...
    elseif typeof(decoder) == Int64
        ...
        decision_step! = (args...) -> decision_step_M_gaussian!(args..., decoder)
