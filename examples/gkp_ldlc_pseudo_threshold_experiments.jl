...
cgrad = range(colorant"red", stop=colorant"blue", length=62);
...
for file_name in file_names
    ...
    plot!(th_pl,sigmas,failure_rates, label="", markershape=:circle,linecolor=cgrad[n-14], markercolor=cgrad[n-14])
    display(th_pl)
