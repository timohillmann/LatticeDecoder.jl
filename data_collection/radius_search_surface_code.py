            ...
            for ls in local_search:
                for ls_lll in local_search_lll:
                    for sch in schedules:
                        ...
                        ax.set_yscale("log")
                        ax.set_xlabel("Search Radius $\epsilon$")
...
paths =[
    ...
    # "quantum_codes/surface_codes_balanced_radius_search",
    "quantum_codes/surface_codes_balanced_bs"
    # "quantum_codes/surface_codes_balanced_radius_search_serial_rev"
    ]
schedules = ["serial", "parallel"]
decoders = ["lsd"] # ["nearest", "lsd"]
local_search = [True]
local_search_lll = [True]
